...
def draw_ball(screen, ball, font):
    p = int(ball.body.position.x), height - int(ball.body.position.y)
    #pygame.draw.circle(screen, (0,0,255), p, int(ball.radius), 2)
    surface = font.render(ball.letter, 0, (255,0,0))
    screen.blit(surface, (p[0] - ball.radius, p[1] - ball.radius))
